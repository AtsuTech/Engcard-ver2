    ...
    return(
        <CommonLayout>
            ...
            <div className="max-w-4xl mx-auto sm:px-6 lg:px-8">
                <div className="bg-white dark:bg-gray-800 dark:text-white p-3">
                    ...
                    <section className="py-3">
                        ...
                        <ul className="list-disc pl-6 py-4">
                            <li>予告無く本サービスの内容を変更、追加または廃止することがあり、ユーザーはこれを承諾するものとします。</li>
                            <li>予告無く本サービスの運営を終了することがございます。終了に伴いユーザーのデータが失われますが、当方は一切責任を負いません。</li>
                        </ul>
                    </section>
