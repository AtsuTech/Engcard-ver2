                        ...
                        <div className="p-5">
                            ...
                            <div>
                                <div className="flex relative py-4">
                                    ...
                                    <div className="pl-2">
                                        <div className="text-2xl dark:text-white">{user.name}</div>
                            ...
                            <div className="flex py-3 text-center text-slate-700 text-sm my-2">
                                <button 
                                    ...
                                    className={
                                        'w-full text-center py-3 border-b border-slate-300 dark:text-slate-200 ' + 
                                        (tabSelects === 0 
                                            ? 'font-bold text-black dark:text-white border-b-2 border-amber-400' 
                                            : '')
                                    }
                                >
                                    公開している単語帳
